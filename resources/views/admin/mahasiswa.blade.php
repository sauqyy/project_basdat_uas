...
<div class="user-segmented-control mb-4">
    <button class="user-segmented-btn active" id="mahasiswa-tab" type="button">
        Mahasiswa
    </button>
    <button class="user-segmented-btn" id="dosen-tab" type="button">
        Dosen
    </button>
</div>
    ...
    <div class="tab-pane fade show active" id="mahasiswa" role="tabpanel">
        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <p class="text-muted mb-3">List dari akun mahasiswa yang terdaftar</p>
        ...
        <div class="card">
            <div class="card-body">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div>
                                        ...
                                        <small class="text-muted">164231108 • Teknik Informatika</small><br>
                                        <small class="text-muted">siti.nurhaliza@gmail.com</small>
                                    </div>
                                </td>
                                <td>
                                    <span class="badge bg-secondary">Unknown</span>
                            ...
                            <tr>
                                <td>
                                    <div>
                                        ...
                                        <small class="text-muted">164231109 • Sistem Informasi</small><br>
                                        <small class="text-muted">budi.santoso@gmail.com</small>
                                    </div>
                                </td>
                                <td>
                                    <span class="badge bg-secondary">Unknown</span>
                            ...
                            <tr>
                                <td>
                                    <div>
                                        <div class="fw-bold">Ahmad Wijaya</div>
                                        <small class="text-muted">164231110 • Teknologi Sains Data</small><br>
                                        <small class="text-muted">ahmad.wijaya@gmail.com</small>
                                    </div>
                                </td>
                                <td>
                                    <span class="badge bg-secondary">Unknown</span>
                ...
                <div class="d-flex justify-content-between align-items-center mt-4">
                    <div>
                        <span class="text-muted">Halaman 1 dari 11</span>
                    </div>
