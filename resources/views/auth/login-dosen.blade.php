...
<head>
    ...
    <title>Login Dosen - Kampus Merdeka</title>
    ...
    @keyframes slide-in-blurred-left {
        ...
        @media (max-width: 768px) {
            ...
            .logo-container {
                width: 200px;
                height: 200px;
                 perspective: 1000px; /* 👈 ini penting */
            }
...
<body>
    ...
    <div class="logo-container">
        <img src="{{ asset('images/logo.png') }}" alt="Kampus Merdeka" class="slide-in-blurred-left">
    </div>
</div>
                ...
                <div class="login-card">
                    ...
                    <form method="POST" action="{{ url('/login') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="email" placeholder="NIP" required>
                        </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            loginForm.addEventListener('submit', function(e) {
                ...
                if (!username || !password) {
                    e.preventDefault();
                    errorText.textContent = 'NIP dan Password harus diisi';
