    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-1">Jadwal Mengajar</h5>
                <p class="text-muted mb-0">Jadwal mata kuliah yang telah di-plot oleh sistem AI</p>
            </div>
            <div class="card-body">
                @if($jadwals->count() > 0)
                ...
                @else
                    <div class="text-center py-5">
                        ...
                        <p class="text-muted">Jadwal mengajar Anda akan muncul di sini setelah di-generate oleh admin.</p>
                    </div>
                @endif
            </div>
        </div>
