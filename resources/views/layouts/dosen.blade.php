...
<head>
    ...
    <title>@yield('title', 'Dosen Dashboard') - Kampus Merdeka</title>
        ...
        <div class="sidebar">
            ...
            <div class="nav-menu">
                ...
                @if(auth()->user()->isSuperAdmin())
                    ...
                    <div class="nav-item">
                        <a href="{{ route('super-admin.kelas') }}" class="nav-link {{ request()->routeIs('super-admin.kelas*') ? 'active' : '' }}">
                            <i class="fas fa-home"></i>
                            Kelola Kelas
                        </a>
                    </div>
                    <div class="nav-item">
                        <a href="{{ route('super-admin.jadwal') }}" class="nav-link {{ request()->routeIs('super-admin.jadwal*') ? 'active' : '' }}">
                ...
                @elseif(auth()->user()->isAdminProdi())
                    <!-- Admin Prodi Menu -->
                    <div class="nav-item">
                        <a href="{{ route('admin-prodi.dashboard') }}" class="nav-link {{ request()->routeIs('admin-prodi.dashboard') ? 'active' : '' }}">
                            <i class="fas fa-tachometer-alt"></i>
                            Dashboard
                        </a>
                    </div>
                    <div class="nav-item">
                        <a href="{{ route('admin-prodi.mata-kuliah') }}" class="nav-link {{ request()->routeIs('admin-prodi.mata-kuliah*') ? 'active' : '' }}">
                            <i class="fas fa-book"></i>
                            Mata Kuliah
                        </a>
                    </div>
                    <div class="nav-item">
                        <a href="{{ route('admin-prodi.dosen') }}" class="nav-link {{ request()->routeIs('admin-prodi.dosen*') ? 'active' : '' }}">
                            <i class="fas fa-users"></i>
                            Dosen
                        </a>
                    </div>
                    <div class="nav-item">
                        <a href="{{ route('admin-prodi.jadwal') }}" class="nav-link {{ request()->routeIs('admin-prodi.jadwal*') ? 'active' : '' }}">
                            <i class="fas fa-calendar-alt"></i>
                            Jadwal
                        </a>
                    </div>
                @elseif(auth()->user()->isDosen())
                    ...
                    <div class="nav-item">
                        <a href="{{ route('dosen.mata-kuliah') }}" class="nav-link {{ request()->routeIs('dosen.mata-kuliah') ? 'active' : '' }}">
                            <i class="fas fa-book"></i>
                            Mata Kuliah
                        </a>
                    </div>
                    <div class="nav-item">
                        <a href="{{ route('dosen.preferensi') }}" class="nav-link {{ request()->routeIs('dosen.preferensi') ? 'active' : '' }}">
            ...
            <div class="header">
                <h1 class="page-title">
                    @yield('page-title', 
                        ...
                        (auth()->user()->isAdminProdi() ? 'Admin Prodi Dashboard' : 'Dashboard Dosen')
                    )
                </h1>
            </div>
